...
"Male Values:"
print
pd.crosstab(trainMale.Pclass, trainMale.Survived, margins=True)
print
""
print
"Female Values:"
print
pd.crosstab(trainFemale.Pclass, trainFemale.Survived, margins=True)
...
print
pd.crosstab(train.FamilyMembers, train.Survived, margins=True)
...
print
train[train.Ticket == 'CA. 2343'].Name, train[train.Ticket == 'CA. 2343'].Survived
print
print
...
print
train[train.Fare == 512.3292].Name
print
print
train[train.Fare == 0].Name
...
for name in train.Name:
    if 'Johnson' in name or 'Andrews' in name:
        print
        name, train[train.Name == name].Fare
...
print
train[train.Name == 'Johnson, Mr. William Cahoone Jr'].FamilyMembers
print
print
train[train.Name == 'Johnson, Mr. Alfred'].FamilyMembers
print
print
train[train.Name == 'Andrews, Mr. Thomas Jr'].FamilyMembers
...
print
pd.crosstab(train.Embarked, train.Sex, margins=True)
print
print
"Males and females from Cherbourg who survived:"
print
train[(train.Embarked == 'C') & (train.Survived == 1)].Sex.value_counts()
print
print
pd.crosstab(train.Embarked, train.Pclass, margins=True)
print
print
pd.crosstab(train.Embarked, train.Family, margins=True)
...
for k, v in algorithms.iteritems():
    print
    v, "trainData score:", k.score(trainData[Predictors], trainData['Survived'])
    print
    v, "testData score:", k.score(testData[Predictors], testData['Survived'])
...
submission.to_csv('/Users/Dave/Desktop/Programming/Personal Projects/titanic_kaggle/Titanic_Submission3.csv',
                  index=False)
